...
libraryDependencies ++= Seq(
  "com.github.finagle" %% "finch-core" % "0.13.1" exclude("org.openjdk.jmh", "*"),
  "com.github.finagle" %% "finch-circe" % "0.13.1" exclude("org.openjdk.jmh", "*"),
...
assemblyExcludedJars in assembly := {
  ...
  cp filter { x =>
    x.data.getName == "finagle-netty4_2.11-6.42.0.jar"
  }
}
